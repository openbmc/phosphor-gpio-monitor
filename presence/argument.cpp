...
const char* ArgumentParser::optionStr = "p:k:n:?h";
...
void ArgumentParser::usage(char** argv)
{
    ...
    std::cerr << "  --path=<path>           *Required* Object path under"
              "inventory to display this inventory item\n";
    std::cerr << "  --key=<key>             *Required* Input GPIO key number\n";
