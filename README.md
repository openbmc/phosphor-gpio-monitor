...
9. ActiveLow: This is an optional flag. If it is defined as true then the
   signal is asserted when the hardware level is LOW. If not defined then the
   line defaults to active-high.
